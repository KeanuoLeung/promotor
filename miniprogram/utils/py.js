...
function isString(varName) {
  return getVarType(varName) === '[object String]';
}
 ...
 **/
export default function (str, extractFirst) {
  var i, tmp, key, result = '',
    flag, firstChar, PYMaps;
  ...
  for (i = 0; i < str.length; i++) {
    ...
    flag = false;
    for (key in PYMaps) {
      if (isString(PYMaps[key]) && PYMaps[key].indexOf(tmp) != -1) {
